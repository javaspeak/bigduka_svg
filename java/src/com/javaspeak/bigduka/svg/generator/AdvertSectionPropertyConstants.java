...
public class AdvertSectionPropertyConstants {

	public static final String X = "#x#";
	public static final String Y = "#y#";
	public static final String TITLE_LINE_1 = "#title_line_1#";
	public static final String TITLE_LINE_2 = "#title_line_2#";
	public static final String TITLE_LINE_3 = "#title_line_3#";
}
